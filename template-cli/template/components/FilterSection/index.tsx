...
const FilterSection = ({
  ...
  const [parameterFilter, setParameterFilter] =
    useState<Parameter>(emptyParameters);
  ...
  const handleSaveActiveState = () => {
    setSaveIsDisabled(
      !Object?.values(parameterFilter)?.some(Boolean) ||
        Object?.entries(parameterFilter)?.every(
            ...
            <div className="filter-section-container">
              ...
              <SelectGroup
                ...
                onChange={(selectedOption: Option) =>
                  handleSelectChange(selectedOption, "lcStatus")
                }
                //put the Options instead of the empty array
                value={
                  [{ label: "", value: "" }].find(
                    (option) => option.value === parameterFilter?.lcStatus
                  ) || null
                }
                isMultiple={false}
                label="LC Status"
